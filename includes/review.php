    ...
    <div class="container my-5">
        <div class="row">
            ...
            <div class="col-6 text-end mb-3">
                <button class="bg-orange text-center rounded-circle border-1 p-2" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="prev">
                ...
                <button class="bg-orange text-center rounded-circle border-1 p-2" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="next">
