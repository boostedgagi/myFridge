...
<div class="modal fade" id="adminAddGrocerie" tabindex="-1" aria-labelledby="adminAddGrocerie" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form method="post" action="./actions/addNewGrocerieAdminAction.php" enctype="multipart/form-data">
                    ...
                    <button type="submit" name="adminGrocerieSubmit" class="btn-lg btn-primary my-3 rounded-pill">
                        Add new Grocerie
                    </button>
